...
!(function (e, t) {
  ...
  function m(e, t, u, n) {
    var r = t.href,
      ...
      i = e[1].replace(/\\([\[\]])/g, "$1");
    return "!" !== e[0].charAt(0) ? ((n.state.inLink = !0), (e = { type: "link", raw: u, href: r, title: t, text: i, tokens: n.inlineTokens(i) }), (n.state.inLink = !1), e) : { type: "image", raw: u, href: r, title: t, text: A(i) };
  }
  var b = (function () {
      function e(e) {
      ...
      return (
        ...
        (t.code = function (e) {
          ...
          if (e) return (t = e[0].replace(/^ {1,4}/gm, "")), { type: "code", raw: e[0], codeBlockStyle: "indented", text: this.options.pedantic ? t : C(t, "\n") };
        }),
        (t.fences = function (e) {
          var t,
            u,
        ...
        (t.heading = function (e) {
          ...
          if (e) return (t = e[2].trim()), /#$/.test(t) && ((u = C(t, "#")), (!this.options.pedantic && u && !/ $/.test(u)) || (t = u.trim())), { type: "heading", raw: e[0], depth: e[1].length, text: t, tokens: this.lexer.inline(t) };
        }),
        (t.hr = function (e) {
        ...
        (t.blockquote = function (e) {
          ...
          if (e) return (t = e[0].replace(/^ *>[ \t]?/gm, "")), (u = this.lexer.state.top), (this.lexer.state.top = !0), (n = this.lexer.blockTokens(t)), (this.lexer.state.top = u), { type: "blockquote", raw: e[0], tokens: n, text: t };
        }),
        (t.list = function (e) {
          ...
          if (t) {
            ...
            for (var F = new RegExp("^( {0,3}" + g + ")((?:[\t ][^\\n]*)?(?:\\n|$))"); e && ((h = !1), (t = F.exec(e))) && !this.rules.block.hr.test(e); ) {
              if (
                ...
                (a = e.split("\n", 1)[0]),
                this.options.pedantic ? ((i = 2), (c = o.trimLeft())) : ((i = t[2].search(/[^ ]/)), (c = o.slice((i = 4 < i ? 1 : i))), (i += t[1].length)),
                (s = !1),
                !o && /^ *$/.test(a) && ((u += a + "\n"), (e = e.substring(a.length + 1)), (h = !0)),
                !h)
              )
                for (
                  var A = new RegExp("^ {0," + Math.min(3, i - 1) + "}(?:[*+-]|\\d{1,9}[.)])((?:[ \t][^\\n]*)?(?:\\n|$))"), k = new RegExp("^ {0," + Math.min(3, i - 1) + "}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)"), d = new RegExp("^ {0," + Math.min(3, i - 1) + "}(?:```|~~~)"), C = new RegExp("^ {0," + Math.min(3, i - 1) + "}#");
        ...
        (t.html = function (e) {
          ...
          if (e) return (t = { type: "html", raw: e[0], pre: !this.options.sanitizer && ("pre" === e[1] || "script" === e[1] || "style" === e[1]), text: e[0] }), this.options.sanitize && ((e = this.options.sanitizer ? this.options.sanitizer(e[0]) : A(e[0])), (t.type = "paragraph"), (t.text = e), (t.tokens = this.lexer.inline(e))), t;
        }),
        (t.def = function (e) {
          var t,
            u,
          ...
          if (e) return (t = e[1].toLowerCase().replace(/\s+/g, " ")), (u = e[2] ? e[2].replace(/^<(.*)>$/, "$1").replace(this.rules.inline._escapes, "$1") : ""), (n = e[3] && e[3].substring(1, e[3].length - 1).replace(this.rules.inline._escapes, "$1")), { type: "def", tag: t, raw: e[0], href: u, title: n };
        }),
        (t.table = function (e) {
        ...
        (t.tag = function (e) {
          ...
          if (e)
            return (
              ...
              { type: this.options.sanitize ? "text" : "html", raw: e[0], inLink: this.lexer.state.inLink, inRawBlock: this.lexer.state.inRawBlock, text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(e[0]) : A(e[0])) : e[0] }
            );
        }),
        (t.link = function (e) {
          ...
          if (e) {
            ...
            var n,
              ...
              r = "";
            return (
              this.options.pedantic ? (n = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(u)) && ((u = n[1]), (r = n[3])) : (r = e[3] ? e[3].slice(1, -1) : ""), (u = u.trim()), m(e, { href: (u = /^</.test(u) ? (this.options.pedantic && !/>$/.test(t) ? u.slice(1) : u.slice(1, -1)) : u) && u.replace(this.rules.inline._escapes, "$1"), title: r && r.replace(this.rules.inline._escapes, "$1") }, e[0], this.lexer)
            );
          }
        }),
        (t.reflink = function (e, t) {
          var u;
          if ((u = (u = this.rules.inline.reflink.exec(e)) || this.rules.inline.nolink.exec(e))) return (e = t[(e = (u[2] || u[1]).replace(/\s+/g, " ")).toLowerCase()]) ? m(u, e, u[0], this.lexer) : { type: "text", raw: (t = u[0].charAt(0)), text: t };
        }),
            ...
            if (!r || "" === u || this.rules.inline.punctuation.exec(u)) {
              ...
              for (o.lastIndex = 0, t = t.slice(-1 * e.length + i); null != (n = o.exec(t)); ) {
                ...
                if (D)
                  ...
                  else if (!(0 < (s -= a))) return (a = Math.min(a, a + s + l)), (D = e.slice(0, i + n.index + (n[0].length - D.length) + a)), Math.min(i, a) % 2 ? ((a = D.slice(1, -1)), { type: "em", raw: D, text: a, tokens: this.lexer.inlineTokens(a) }) : ((a = D.slice(2, -2)), { type: "strong", raw: D, text: a, tokens: this.lexer.inlineTokens(a) });
              }
            }
          }
        }),
        (t.codespan = function (e) {
          ...
          if (e) return (n = e[2].replace(/\n/g, " ")), (t = /[^ ]/.test(n)), (u = /^ /.test(n) && / $/.test(n)), (n = A((n = t && u ? n.substring(1, n.length - 1) : n), !0)), { type: "codespan", raw: e[0], text: n };
        }),
        (t.br = function (e) {
        ...
        (t.autolink = function (e, t) {
          ...
          if (e) return (t = "@" === e[2] ? "mailto:" + (u = A(this.options.mangle ? t(e[1]) : e[1])) : (u = A(e[1]))), { type: "link", raw: e[0], text: u, href: t, tokens: [{ type: "text", raw: u, text: u }] };
        }),
        (t.url = function (e, t) {
          var u, n, r, i;
        ...
        (t.inlineText = function (e, t) {
          ...
          if (e) return (t = this.lexer.state.inRawBlock ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(e[0]) : A(e[0])) : e[0]) : A(this.options.smartypants ? t(e[0]) : e[0])), { type: "text", raw: e[0], text: t };
        }),
        e
      );
    })(),
    ...
    w =
      ...
      (B.html = p(B.html, "i")
        ...
        .getRegex()),
      (B.paragraph = p(B._paragraph).replace("hr", B.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", B._tag).getRegex()),
      (B.blockquote = p(B.blockquote).replace("paragraph", B.paragraph).getRegex()),
      (B.normal = F({}, B)),
      (B.gfm = F({}, B.normal, { table: "^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)" })),
  ...
  (w._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    ...
    (w.emStrong.rDelimAst = p(w.emStrong.rDelimAst, "g").replace(/punct/g, w._punctuation).getRegex()),
    (w.emStrong.rDelimUnd = p(w.emStrong.rDelimUnd, "g").replace(/punct/g, w._punctuation).getRegex()),
    (w._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (w._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (w._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (w.link = p(w.link).replace("label", w._label).replace("href", w._href).replace("title", w._title).getRegex()),
    ...
    (w.reflinkSearch = p(w.reflinkSearch, "g").replace("reflink", w.reflink).replace("nolink", w.nolink).getRegex()),
    (w.normal = F({}, w)),
  ...
  var v = (function () {
      function u(e) {
        (this.tokens = []), (this.tokens.links = Object.create(null)), (this.options = e || r.defaults), (this.options.tokenizer = this.options.tokenizer || new b()), (this.tokenizer = this.options.tokenizer), (this.tokenizer.options = this.options), ((this.tokenizer.lexer = this).inlineQueue = []), (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
            ...
            if (
              ...
              !(
                ...
                this.options.extensions.inline.some(function (e) {
                  return !!(u = e.call({ lexer: o }, r, t)) && ((r = r.substring(u.raw.length)), t.push(u), !0);
                })
              ))
            )
    ...
    S = (function () {
      ...
      return (
        (e.parse = function (e, t) {
          void 0 === t && (t = !0);
          for (var u, n, r, i, s, l, o, a, D, c, h, p, f, g, F, A, k = "", d = e.length, C = 0; C < d; C++)
            if (((a = e[C]), this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[a.type] && (!1 !== (A = this.options.extensions.renderers[a.type].call({ parser: this }, a)) || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(a.type)))) k += A || "";
            else
              switch (a.type) {
                case "space":
                  continue;
                ...
                case "code":
                  ...
                  continue;
                case "table":
                  for (l = D = "", r = a.header.length, u = 0; u < r; u++) l += this.renderer.tablecell(this.parseInline(a.header[u].tokens), { header: !0, align: a.align[u] });
                  for (D += this.renderer.tablerow(l), o = "", r = a.rows.length, u = 0; u < r; u++) {
                    for (l = "", i = (s = a.rows[u]).length, n = 0; n < i; n++) l += this.renderer.tablecell(this.parseInline(s[n].tokens), { header: !1, align: a.align[n] });
                ...
                case "blockquote":
                  ...
                  continue;
                case "list":
                  for (D = a.ordered, E = a.start, c = a.loose, r = a.items.length, o = "", u = 0; u < r; u++)
                    (f = (p = a.items[u]).checked),
                      (g = p.task),
                      (h = ""),
                      p.task &&
                        ((F = this.renderer.checkbox(f)), c ? (0 < p.tokens.length && "paragraph" === p.tokens[0].type ? ((p.tokens[0].text = F + " " + p.tokens[0].text), p.tokens[0].tokens && 0 < p.tokens[0].tokens.length && "text" === p.tokens[0].tokens[0].type && (p.tokens[0].tokens[0].text = F + " " + p.tokens[0].tokens[0].text)) : p.tokens.unshift({ type: "text", text: F })) : (h += F)),
  ...
  (T.passThroughHooks = new Set(["preprocess", "postprocess"])),
    ...
    (I.use = function () {
      for (var D = I.defaults.extensions || { renderers: {}, childTokens: {} }, e = arguments.length, t = new Array(e), u = 0; u < e; u++) t[u] = arguments[u];
